...
import type { ColumnsType, ColumnType, DataIndex, Key } from '../components/interface';
...
export declare function setPathValue<ValueType, ObjectType extends object>(record: ObjectType, path: DataIndex, value: ValueType): ValueType;
export declare function isValidElement(element: any): boolean;
export declare const parseStyleText: (cssText?: string | CSSProperties, camel?: boolean) => {};
...
export declare const isPromise: (promise: any) => boolean;
export declare function ensureValidVNode(vnodes: any): any;
