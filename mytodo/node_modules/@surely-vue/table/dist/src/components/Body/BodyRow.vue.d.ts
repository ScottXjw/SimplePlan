...
declare const _default: import("vue").DefineComponent<{
    ...
    flattenRowIndex: NumberConstructor;
    ...
    handleCellBlur: () => void;
    handleCellHover: (rowKey: import("../interface").Key, columnKey: import("../interface").Key, draggingRowKey: import("../interface").Key) => void;
    handleClick: () => void;
    ...
    mergedColumns: import("vue").ComputedRef<import("../interface").FinallyColumnType<import("../interface").DefaultRecordType>[]>;
    ...
    editCellKeys: import("vue").Ref<string[]>;
    closeEditor: (key?: string | string[]) => void;
    openEditor: (key: string) => void;
    mergedTooltipOpen: import("vue").ComputedRef<boolean>;
    onCellMousedown: (mouseEvent: MouseEvent, cellPosition: import("../../hooks/RangeInterface").RangeCell) => void;
    onCellKeydown: (event: KeyboardEvent, payload: import("../../hooks/RangeInterface").KeydownPayload) => void;
    onCellMousemove: (mouseEvent: MouseEvent, cellPosition: import("../../hooks/RangeInterface").RangeCell) => void;
    onCellClick: (mouseEvent: MouseEvent, cellPosition: import("../../hooks/RangeInterface").RangeCell) => void;
