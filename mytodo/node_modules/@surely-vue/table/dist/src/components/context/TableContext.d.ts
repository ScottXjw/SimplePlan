...
import type { ColumnsType, DragColumnEventInfo, DragRowEventInfo, ExpandType, GetPopupContainer, GetRowKey, Key, Position, SummaryFixed, SurelyTableProps, TableLocale, TableRowSelection, TriggerEventHandler } from '../interface';
