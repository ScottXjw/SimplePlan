...
import type { ColumnGroupType, ColumnType, DefaultRecordType, FinallyColumnType, Key } from '../components/interface';
export declare type RowPinned = 'top' | 'bottom' | null;
