...
import type { FlatRecord, Key, SurelyTableProps } from '../components/interface';
...
export default function useCal(props: SurelyTableProps, flattenData: Ref<FlatRecord[]>, scrollHeight: Ref<number>, scrollTop: Ref<number>, virtual: Ref<boolean>, keyEntities: Ref<KeyEntities>): CalType;
